...
macro(find_flann)
  ...
  elseif(NOT FLANN_ROOT)
    get_filename_component(FLANN_ROOT "/opt/ros/fuerte/include" PATH)
  endif(PCL_ALL_IN_ONE_INSTALLER)
  if(PKG_CONFIG_FOUND)
...
elseif(EXISTS "${PCL_DIR}/include/pcl/pcl_config.h")
  ...
  set(PCL_SOURCES_TREE "/home/sachin/Workspace/pcl")
...
set(pcl_all_components  common octree io kdtree search sample_consensus filters tracking surface 2d features geometry visualization ml segmentation stereo registration recognition keypoints simulation )
